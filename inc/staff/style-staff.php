...
<style>
    ...
    .arms-subnav-link { padding: 10px 20px; text-decoration: none; color: #fff; font-weight: 600; font-size: 13px; border-bottom: 2px solid transparent; margin-bottom: -2px; transition: all 0.15s ease; background-color: #003376;}
    .arms-subnav-link:hover { color: #fff; }
    .arms-subnav-link.active { color: #fff; border-bottom-color: #003376; }
    ...
    .arms-submit-btn { background: #003376; color: #fff; border: none; padding: 12px 24px; font-size: 13px; font-weight: 600; border-radius: 6px; cursor: pointer; text-decoration: none; display: inline-block; }
    ...
    .profile-large-avatar { width: 150px; height: 150px; border-radius: 50%; object-fit: cover; border: 3px solid #003376; margin-bottom: 15px; background: #f1f5f9; }
    .profile-large-fallback { width: 150px; height: 150px; border-radius: 50%; background: #003376; color: #fff; font-size: 48px; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px auto; font-weight: bold; }
